    ...
    <section>
      ...
      <div className='flex mb-[128px] justify-between'>
        <div className='flex flex-col items-center border-2 border-solid px-[80px] py-[48px] border-additional1'>
            ...
            <input className='h-[48px] w-[377px] bg-main1 placeholder-additional2  mb-[16px]' type="text" placeholder='Name'/>
            <input className='h-[48px] w-[377px] bg-main1 placeholder-additional2 mb-[16px]' type="text" placeholder='000-000-0000'/>
            <input className='h-[48px] w-[377px] bg-main1 placeholder-additional2 mb-[16px]' type="text" placeholder='Your@email.com'/>
            <input className='h-[48px] w-[377px] bg-main1 placeholder-additional2 mb-[16px]' type="text" placeholder='Your address'/>
            <input className='h-[48px] w-[377px] bg-main1 placeholder-additional2 mb-[24px]' type="text" placeholder='Description'/>
            
            <button className='border-accent border-2 w-[242px] h-[72px]'>Consultation</button>
        </div>
        <div>
            <h3 className='font-inter font-bold text-xl leading-[1.2104] pb-[24px]'>Call</h3>
            ...
            <h3 className='font-inter font-bold text-xl leading-[1.2104] pb-[24px]'>Location</h3>
