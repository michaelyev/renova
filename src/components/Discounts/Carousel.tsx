...
<div className="mx-auto">
    <Image src='/images/icons/left_arrow_discount.svg' width={80} height={0} />
</div>

<ul className="flex gap-[20px] m-width-[1320px] ">
...
<div className="mx-auto">
    <Image src='/images/icons/right_arrow_discount.svg' width={80} height={0} />
</div>
</div>
    </div>
  )
